	...
	data: () => ({
		tables: {
			table1: {
				name: 'Virus Detail',
				data: [
						{ name: 'Virus name', key: 'Virus_name', has_tag: false },
			...
			table2: {
				...
				data: [
						{ name: 'Collection date', key: 'Collection_date', has_tag: false },
						{ name: 'State', key: 'State', has_tag: false },
						{ name: 'District', key: 'District', has_tag: false },
						{ name: 'Patient status', key: 'Patient_status', has_tag: false },
						{ name: 'Last vaccinated', key: 'Last_vaccinated', has_tag: false },
						{ name: 'Treatment', key: 'Treatment', has_tag: false },
						{ name: 'Sequencing technology', key: 'Sequencing_technology', has_tag: false },
						{ name: 'Assembly method', key: 'Assembly_method', has_tag: false },
						{ name: 'Originating Lab', key: 'Originating_lab', has_tag: false },
						{ name: 'Submitting Lab', key: 'Submitting_lab', has_tag: false },
					],
			},
		}
	}),
